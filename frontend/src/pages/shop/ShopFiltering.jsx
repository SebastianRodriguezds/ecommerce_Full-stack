        ...
        <div className='flex flex-col space-y-2'>
            ...
            <hr />
            {
                filters.categories.map((category)=> (
                    <label key={category} htmlFor="" className='capitalize cursor-pointer'>
        ...
        <div className='flex flex-col space-y-2'>
            ...
            <hr />
            {
                filters.colors.map((color)=> (
                    <label key={color} htmlFor="" className='capitalize cursor-pointer'>
        ...
        <div className='flex flex-col space-y-2'>
            ...
            <hr />
            {
                filters.priceRanges.map((range)=> (
                    <label key={range.label} htmlFor="" className='capitalize cursor-pointer'>
